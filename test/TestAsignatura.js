...
contract('Asignatura:', accounts => {
    ...
    it("La asignatura es BCDA del curso 2020-2021",  async () => {
        ...
        assert.equal(curso, "2020-2021", "La asignatura es del curso 2020-2021.");
    })
    ...
    it("Crear dos evaluaciones correctamente",  async () => {
        ...
        assert.equal(evaluacion0.puntos, 30, "El primer parcial debe valer 3 puntos.");
        ...
        assert.equal(evaluacion1.puntos, 70, "El examen final debe valer 7 puntos.");
    })
